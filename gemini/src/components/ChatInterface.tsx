...
export const ChatInterface = () => {
  ...
  return (
    ...
    <div className="flex flex-col h-screen sm:h-[85vh] md:h-[80vh] max-h-[100dvh] w-full max-w-4xl mx-auto glass sm:rounded-3xl overflow-hidden shadow-xl border border-black/5 bg-white/40">
      ...
      <form onSubmit={handleSubmit} className="p-3 sm:p-4 md:p-6 bg-black/5 border-t border-black/10 safe-area-bottom">
        ...
        <div className="relative group">
          <input
            ...
            className="w-full bg-white/50 border border-black/10 rounded-xl sm:rounded-2xl py-3 sm:py-4 pl-4 sm:pl-6 pr-12 sm:pr-14 focus:outline-none focus:ring-2 focus:ring-purple-500/30 focus:border-purple-500/40 transition-all text-sm sm:text-base text-black placeholder:text-black/20"
          />
          <button
            type="submit"
            disabled={!input || isLoading}
            aria-label="Send message"
            className="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 p-2 rounded-lg sm:rounded-xl bg-purple-600 hover:bg-purple-500 active:scale-95 disabled:bg-black/10 disabled:text-black/20 transition-all shadow-md text-white"
          >
