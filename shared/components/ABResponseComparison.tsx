  ...
  return (
    <div
      className={cn(
        ...
        isSelected && 'border-purple-500 bg-purple-50 shadow-lg shadow-purple-100',
        ...
        !isDisabled && 'hover:border-purple-300 hover:shadow-md cursor-pointer'
      )}
    >
      ...
      <div
        className={cn(
          ...
          'prose prose-slate prose-sm max-w-none flex-1',
      ...
      <button
        ...
        className={cn(
          ...
          isSelected && 'bg-purple-700 ring-2 ring-purple-300 ring-offset-2'
        )}
      >
